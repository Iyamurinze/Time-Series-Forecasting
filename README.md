...
docs/
  UNDERSTANDING.md         Plain-language guide to the whole project — start here
  RELATED_WORK.md          Annotated bibliography — each source tied to the decision it informed
  REPORT_OUTLINE.md        Report structure, with the evidence behind each claim
  VIDEO_SCRIPT.md          Presentation script with timings and likely viva questions
reports/
...
See `docs/RELATED_WORK.md` and the report's reference list.
